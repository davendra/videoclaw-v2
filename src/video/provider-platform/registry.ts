...
export const DEFAULT_PROVIDER_REGISTRY: VideoProviderDescriptor[] = [
  ...
  },
  {
    ...
    path: "useapi",
    summary: "First-wave Kling adapter surface optimized for motion control and reusable element flows.",
    controls: [
      "first-frame",
      "last-frame",
      "reference-images",
    ...
    escapeHatches: [
      {
        name: "klingOptions",
        description: "Keep Kling-native controls available for motion and reusable elements.",
        options: [
          {
            name: "motionStrength",
            description: "Expose Kling motion-control intensity without flattening it away.",
          },
          {
            name: "elementReuse",
            description: "Retain reusable element / actor continuity controls.",
          },
        ],
      },
    ],
    notes: [
      "Prepared as a first-wave UseAPI-backed adapter with provider-specific motion escape hatches.",
    ],
  },
];
