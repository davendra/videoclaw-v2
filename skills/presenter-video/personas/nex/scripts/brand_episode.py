...
PERSONA_DIR = os.path.dirname(SCRIPT_DIR)
PRESENTER_SKILL_DIR = os.path.dirname(os.path.dirname(PERSONA_DIR))
SKILLS_DIR = os.path.dirname(PRESENTER_SKILL_DIR)
ASSETS_DIR = os.path.join(PERSONA_DIR, "assets")
